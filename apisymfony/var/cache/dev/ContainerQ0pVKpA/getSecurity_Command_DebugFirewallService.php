...
class getSecurity_Command_DebugFirewallService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['security.command.debug_firewall'] = $instance = new \Symfony\Bundle\SecurityBundle\Command\DebugFirewallCommand($container->parameters['security.firewalls'], ($container->privates['.service_locator.4QeXDrO'] ?? $container->get_ServiceLocator_4QeXDrOService()), ($container->privates['.service_locator.zJR52sE'] ?? $container->load('get_ServiceLocator_ZJR52sEService')), ['login' => [0 => ($container->privates['security.authenticator.json_login.login'] ?? $container->load('getSecurity_Authenticator_JsonLogin_LoginService'))], 'register' => [], 'test' => [0 => ($container->privates['security.authenticator.jwt.test'] ?? $container->load('getSecurity_Authenticator_Jwt_TestService'))], 'main' => []], false);
