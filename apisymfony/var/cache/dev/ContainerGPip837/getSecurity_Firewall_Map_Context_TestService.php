 ...
 */
class getSecurity_Firewall_Map_Context_TestService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.firewall.map.context.test'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(new RewindableGenerator(function () use ($container) {
            ...
            yield 1 => ($container->privates['debug.security.firewall.authenticator.test'] ?? $container->load('getDebug_Security_Firewall_Authenticator_TestService'));
            yield 2 => ($container->privates['security.access_listener'] ?? $container->load('getSecurity_AccessListenerService'));
        }, 3), new \Symfony\Component\Security\Http\Firewall\ExceptionListener(($container->privates['security.token_storage'] ?? $container->getSecurity_TokenStorageService()), ($container->privates['security.authentication.trust_resolver'] ?? ($container->privates['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver())), ($container->privates['security.http_utils'] ?? $container->load('getSecurity_HttpUtilsService')), 'test', ($container->privates['security.authenticator.jwt.test'] ?? $container->load('getSecurity_Authenticator_Jwt_TestService')), NULL, NULL, ($container->privates['logger'] ?? ($container->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())), true), NULL, new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('test', 'security.user_checker', '.security.request_matcher.dyWhywe', true, true, 'app.core.domain.provider.auth_user_provider', NULL, 'security.authenticator.jwt.test', NULL, NULL, [0 => 'jwt'], NULL));
    }
}
