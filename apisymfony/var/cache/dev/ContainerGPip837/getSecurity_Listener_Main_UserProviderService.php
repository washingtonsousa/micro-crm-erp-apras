...
class getSecurity_Listener_Main_UserProviderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.listener.main.user_provider'] = new \Symfony\Component\Security\Http\EventListener\UserProviderListener(($container->services['app.core.domain.provider.auth_user_provider'] ?? $container->load('getApp_Core_Domain_Provider_AuthUserProviderService')));
    }
}
