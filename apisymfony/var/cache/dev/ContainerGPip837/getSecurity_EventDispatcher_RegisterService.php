 ...
 */
class getSecurity_EventDispatcher_RegisterService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'security.event_dispatcher.register' shared service.
     *
     * @return \Symfony\Component\EventDispatcher\EventDispatcher
     */
    public static function do($container, $lazyLoad = true)
    {
        $container->privates['security.event_dispatcher.register'] = $instance = new \Symfony\Component\EventDispatcher\EventDispatcher();

        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => function () use ($container) {
            return ($container->privates['security.listener.user_checker.register'] ?? $container->load('getSecurity_Listener_UserChecker_RegisterService'));
