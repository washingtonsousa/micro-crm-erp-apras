...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b->addDriver(($container->privates['doctrine.orm.default_annotation_metadata_driver'] ?? $container->load('getDoctrine_Orm_DefaultAnnotationMetadataDriverService')), 'App\\Core\\Domain\\Entity');

        $a->setEntityNamespaces(['App' => 'App\\Core\\Domain\\Entity']);
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'app.core.domain.repository.usuario_repository' => ['services', 'app.core.domain.repository.usuario_repository', 'getApp_Core_Domain_Repository_UsuarioRepositoryService', true],
        ], [
            'app.core.domain.repository.usuario_repository' => '?',
        ])));
